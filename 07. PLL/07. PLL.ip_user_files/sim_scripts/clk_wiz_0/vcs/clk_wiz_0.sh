...
#
# Generated by Vivado on Mon May 18 11:42:21 +0300 2026
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    $ref_dir/../../../../07.\\ PLL.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v \
    $ref_dir/../../../../07.\\ PLL.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.v \
  2>&1 | tee -a vlogan.log
