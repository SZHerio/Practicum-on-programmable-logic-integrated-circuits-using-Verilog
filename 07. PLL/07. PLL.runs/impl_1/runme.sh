...
HD_PWD='C:/Users/SZHerio/Desktop/Practicum-on-programmable-logic-integrated-circuits-using-Verilog/07. PLL/07. PLL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log task2_clk_wiz.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source task2_clk_wiz.tcl -notrace
