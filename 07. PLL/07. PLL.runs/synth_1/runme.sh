...
HD_PWD='C:/Users/SZHerio/Desktop/Practicum-on-programmable-logic-integrated-circuits-using-Verilog/07. PLL/07. PLL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log task2_clk_wiz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source task2_clk_wiz.tcl
