...
HD_PWD='C:/Users/SZHerio/Desktop/Practicum-on-programmable-logic-integrated-circuits-using-Verilog/03. DSP/03. DSP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_simd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alu_simd.tcl
